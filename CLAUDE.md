...
- **이미지 캐러셀** (NEW):
  - 전시 오프닝, 시상식, 기자회견 등 사진
  - 좌우 네비게이션 버튼
  - 하단 점 인디케이터
  - `/public/images/about/` 폴더에 이미지 추가 가능

### 5. **작품 갤러리**
- 기본: 3개 작품만 표시
- "View All Artworks" 버튼으로 전체 보기 (NEW)
- 전체 보기: 6개 작품 그리드 (데스크톱 3단)
- "Show Less" 버튼으로 다시 축소 (NEW)
...
**2. About 섹션 실제 이미지 추가**
   - `/public/images/about/` 폴더에 사진 추가
   - photo-1.jpg, photo-2.jpg, photo-3.jpg
   - 대통령 악수, 전시 오프닝, 뉴스 인터뷰 등
